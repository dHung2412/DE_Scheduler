...
from pyspark.sql.functions import (
    col, from_json, to_timestamp, to_date, when, lit, 
    coalesce, current_timestamp, get_json_object
)
...
def create_silver_table_if_not_exists(spark: SparkSession):
    ...
    sql_file_path = r"D:\Project\Data_Engineering\DE_Scheduler\utils\sql\silver_table.sql"
